      ...
      CM.makeColoreds
        `shouldBe` V.fromList
          [ RedCard (CKActionCard (ActionCard {kind = Skip, score = 20})),
            ...
            RedCard (CKFaceCard (FaceCard {kind = 8, score = 8})),
            RedCard (CKFaceCard (FaceCard {kind = 9, score = 9})),
            YellowCard (CKActionCard (ActionCard {kind = Skip, score = 20})),
            YellowCard (CKActionCard (ActionCard {kind = Skip, score = 20})),
            YellowCard (CKActionCard (ActionCard {kind = Draw2, score = 20})),
            YellowCard (CKFaceCard (FaceCard {kind = 0, score = 0})),
            YellowCard (CKFaceCard (FaceCard {kind = 1, score = 1})),
            YellowCard (CKFaceCard (FaceCard {kind = 2, score = 2})),
            YellowCard (CKFaceCard (FaceCard {kind = 3, score = 3})),
            YellowCard (CKFaceCard (FaceCard {kind = 4, score = 4})),
            YellowCard (CKFaceCard (FaceCard {kind = 5, score = 5})),
            YellowCard (CKFaceCard (FaceCard {kind = 6, score = 6})),
            YellowCard (CKFaceCard (FaceCard {kind = 7, score = 7})),
            YellowCard (CKFaceCard (FaceCard {kind = 8, score = 8})),
            YellowCard (CKFaceCard (FaceCard {kind = 9, score = 9})),
            GreenCard (CKActionCard (ActionCard {kind = Skip, score = 20})),
            GreenCard (CKActionCard (ActionCard {kind = Skip, score = 20})),
            GreenCard (CKActionCard (ActionCard {kind = Draw2, score = 20})),
            GreenCard (CKFaceCard (FaceCard {kind = 0, score = 0})),
            ...
            GreenCard (CKFaceCard (FaceCard {kind = 8, score = 8})),
            GreenCard (CKFaceCard (FaceCard {kind = 9, score = 9})),
            BlueCard (CKActionCard (ActionCard {kind = Skip, score = 20})),
            BlueCard (CKActionCard (ActionCard {kind = Skip, score = 20})),
            BlueCard (CKActionCard (ActionCard {kind = Draw2, score = 20})),
            BlueCard (CKFaceCard (FaceCard {kind = 0, score = 0})),
            BlueCard (CKFaceCard (FaceCard {kind = 1, score = 1})),
            BlueCard (CKFaceCard (FaceCard {kind = 2, score = 2})),
            BlueCard (CKFaceCard (FaceCard {kind = 3, score = 3})),
            BlueCard (CKFaceCard (FaceCard {kind = 4, score = 4})),
            BlueCard (CKFaceCard (FaceCard {kind = 5, score = 5})),
            BlueCard (CKFaceCard (FaceCard {kind = 6, score = 6})),
            BlueCard (CKFaceCard (FaceCard {kind = 7, score = 7})),
            BlueCard (CKFaceCard (FaceCard {kind = 8, score = 8})),
            BlueCard (CKFaceCard (FaceCard {kind = 9, score = 9})),
            RedCard (CKActionCard (ActionCard {kind = Skip, score = 20})),
            RedCard (CKActionCard (ActionCard {kind = Skip, score = 20})),
            RedCard (CKActionCard (ActionCard {kind = Draw2, score = 20})),
            RedCard (CKFaceCard (FaceCard {kind = 1, score = 1})),
